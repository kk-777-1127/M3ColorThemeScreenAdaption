            ...
            bottomBar = {
                ...
                NavigationBar {
                    NavigationRoots.entries.forEach { item ->
                        NavigationBarItem(
                            icon = { Icon(imageVector = Icons.Default.ArrowForward, contentDescription = "") },
                        ...
                        IconButton(
                            onClick = {
                                ...
                                screenNavController.navigate(
                                    entries[try { entries.indexOf(route) + 1 } catch (e: Exception) { 0 }].root
                                )
                            },
                ...
                item {
                    Card(
                        ...
                        Column(modifier = Modifier
                            ...
                            Text(style = MaterialTheme.typography.bodyMedium,text = "bodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybodybody")
                        }
                    }
                }
